...
public class CourseDetailsController : Controller
{
    ...
    public CourseDetailsController(IPractiflyContext context, IConfigurationProvider configurationProvider)
    {
        _context = context;
    ...
    public async Task<IActionResult> GetThemesInUserCourse(int courseId)
    {
        ...
        var themes = await _context
            ...
            .ProjectTo<CourseThemeItemDto>(_mapper.ConfigurationProvider)
            .ToListAsync();
    ...
    public async Task<IActionResult> GetMaterialsInUserThemes(int themeId)
    {
        ...
        result.Materials = await _context
            ...
            .ProjectTo<CourseMaterialItemDto>(_mapper.ConfigurationProvider)
            .ToArrayAsync();
    ...
    public async Task<IActionResult> GetUserInfoInMaterial(int materialId)
    {
        ...
        var userMaterial = await _context
            ...
            .ProjectTo<UserMaterialInfoDto>(_mapper.ConfigurationProvider)
            .FirstOrDefaultAsync();
